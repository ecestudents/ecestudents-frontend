  ...
  public committees = [
    {
      ...
      link: "24hbg",
      positions: ["Chairman", "External Relations Officers", "Event Managers"],
    ...
    },
    {
      ...
      title: "HeadhuntEURs",
      link: "headhunteurs",
      positions: ["HeadhuntEURs (a.k.a. start-up analysts)"],
    ...
    },
    {
      ...
      title: "Marketing",
      link: "marketing",
      positions: ["Graphic Designers", "Photographers", "Videographers", "Social Media Manager/Copywriter", "Showmaster", "Podcast Manager", "Vlog Manager", "Web Designer"],
    ...
    },
    {
      ...
      title: "DevSquad",
      link: "devsquad",
      positions: ["Web Developer (internal)", "Tech Events (external)"],
