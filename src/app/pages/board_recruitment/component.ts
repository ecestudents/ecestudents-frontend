  ...
  positions = [
    {
      ...
      required_skills: ["Strategic thinking",
        "Business etiquette",
        "Public speaking",
        "Leadership"
      ],
    ...
    },
    {
      ...
      text: ["ECE Students hosts several entrepreneurial events for creative ideas to blossom. The Programme Manager is at the centre of this essence with a capacity to translate visions into reality. You will be responsible for leading, motivating and delegating responsibilities to 3 event committees.",
    ...
    },
    {
      ...
      text: ["Can you be charming yet get the job done? Are you a smooth operator that can bring in paper?",
    ...
    },
    {
      ...
      preferred_skills: ["Programming Experience",
        "Illustrator",
        "Photoshop",
        "Photography",
        "Videography"]
